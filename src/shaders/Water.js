...
class Water extends Mesh {
  constructor(geometry, options = {}) {
    ...
    const reflectanceScale =
      options.reflectanceScale !== undefined ? options.reflectanceScale : 1.0;
    ...
    const mirrorShader = {
      ...
      fragmentShader: /* glsl */ `
				...
				uniform float time;
				uniform float size;
        uniform float reflectanceScale;
          ...
          float reflectance = rf0 + ( 1.0 - rf0 ) * pow( ( 1.0 - theta ), 5.0 );
					vec3 scatter = max( 0.0, dot( surfaceNormal, eyeDirection ) ) * vec3(0, 0, 0);
					vec3 albedo = mix( ( vec3(0, 0, 0) ), ( waterColor + reflectionSample * 0.9 ), reflectance * reflectanceScale);
    ...
    material.uniforms["reflectanceScale"].value = reflectanceScale;
